...
export const fluidLitePresets: Record<FluidLiteQuality, FluidLiteConfig> = {
  off: {
    ...
    yinYangCurrentSeamAmplitude: 0,
    yinYangCurrentSeamLength: 0,
    yinYangCurrentLaneOffset: 0,
    yinYangCurrentEyeSeparation: 0,
    yinYangCurrentEyeRadius: 0,
    yinYangCurrentEyeStrength: 0,
    yinYangCurrentColorSeparation: 1,
    yinYangCurrentSeamPointCount: 0,
    yinYangCurrentFieldScale: 1,
    yinYangCurrentDyeOpacity: 0,
    yinYangCurrentWavefrontOpacity: 0,
    yinYangCurrentBridgeOpacity: 0,
    yinYangCurrentTurbulenceOpacity: 0,
    yinYangCurrentEyeOpacity: 0,
  ...
  low: {
    ...
    autoCurrentBridgeCount: 3,
    autoCurrentBridgeStrength: 0.22,
    autoCurrentHalfSeparation: 1.12,
    yinYangCurrentMode: "seam",
    yinYangCurrentTiltDeg: -7,
    yinYangCurrentSeamAmplitude: 0.2,
    yinYangCurrentSeamLength: 0.78,
    yinYangCurrentLaneOffset: 0.052,
    yinYangCurrentEyeSeparation: 0.15,
    yinYangCurrentEyeRadius: 0.048,
    yinYangCurrentEyeStrength: 0.36,
    yinYangCurrentColorSeparation: 0.68,
    yinYangCurrentSeamPointCount: 6,
    yinYangCurrentFieldScale: 0.96,
    yinYangCurrentDyeOpacity: 0.76,
    yinYangCurrentWavefrontOpacity: 0.16,
    yinYangCurrentBridgeOpacity: 0.26,
    yinYangCurrentTurbulenceOpacity: 0.08,
    yinYangCurrentEyeOpacity: 1.12,
    wavefrontEnabled: true,
    wavefrontMode: "yinYang",
    wavefrontPointCount: 3,
    wavefrontSpeed: 0.036,
    wavefrontRibbonWidth: 0.022,
    wavefrontSAmplitude: 0.2,
    wavefrontSLength: 0.78,
    wavefrontTangentStrength: 0.24,
    wavefrontCenterPull: 0.1,
    wavefrontDyeStrength: 0.16,
    wavefrontAlphaBias: 0.68,
    wavefrontColorSeparation: 1.02,
    wavefrontNoiseAmount: 0.002,
  ...
  medium: {
    ...
    autoCurrentBridgeCount: 4,
    autoCurrentBridgeStrength: 0.26,
    autoCurrentHalfSeparation: 1.16,
    yinYangCurrentMode: "seam",
    yinYangCurrentTiltDeg: -8,
    yinYangCurrentSeamAmplitude: 0.24,
    yinYangCurrentSeamLength: 0.84,
    yinYangCurrentLaneOffset: 0.064,
    yinYangCurrentEyeSeparation: 0.18,
    yinYangCurrentEyeRadius: 0.06,
    yinYangCurrentEyeStrength: 0.46,
    yinYangCurrentColorSeparation: 0.74,
    yinYangCurrentSeamPointCount: 9,
    yinYangCurrentFieldScale: 1.02,
    yinYangCurrentDyeOpacity: 0.92,
    yinYangCurrentWavefrontOpacity: 0.24,
    yinYangCurrentBridgeOpacity: 0.32,
    yinYangCurrentTurbulenceOpacity: 0.1,
    yinYangCurrentEyeOpacity: 1.28,
    wavefrontEnabled: true,
    wavefrontMode: "yinYang",
    wavefrontPointCount: 4,
    wavefrontSpeed: 0.04,
    wavefrontRibbonWidth: 0.026,
    wavefrontSAmplitude: 0.24,
    wavefrontSLength: 0.84,
    wavefrontTangentStrength: 0.3,
    wavefrontCenterPull: 0.13,
    wavefrontDyeStrength: 0.22,
    wavefrontAlphaBias: 0.72,
    wavefrontColorSeparation: 1.08,
    wavefrontNoiseAmount: 0.002,
  ...
  high: {
    ...
    yinYangCurrentSeamAmplitude: 0.27,
    yinYangCurrentSeamLength: 0.88,
    yinYangCurrentLaneOffset: 0.075,
    yinYangCurrentEyeSeparation: 0.2,
    yinYangCurrentEyeRadius: 0.074,
    yinYangCurrentEyeStrength: 0.56,
    yinYangCurrentColorSeparation: 0.78,
    yinYangCurrentSeamPointCount: 13,
    yinYangCurrentFieldScale: 1.05,
    yinYangCurrentDyeOpacity: 1.08,
    yinYangCurrentWavefrontOpacity: 0.3,
    yinYangCurrentBridgeOpacity: 0.36,
    yinYangCurrentTurbulenceOpacity: 0.12,
    yinYangCurrentEyeOpacity: 1.46,
    wavefrontEnabled: true,
    wavefrontMode: "yinYang",
    wavefrontPointCount: 5,
    wavefrontSpeed: 0.043,
    wavefrontRibbonWidth: 0.028,
    wavefrontSAmplitude: 0.27,
    wavefrontSLength: 0.88,
